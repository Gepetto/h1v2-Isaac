...
import robot_tasks.tasks.locomotion.velocity.mdp as rew
import robot_tasks.utils.mdp.commands as commands
import robot_tasks.utils.mdp.events as events

from robot_assets.robots.h12 import H12_27DOF as ROBOT_CFG  # isort: skip
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformVelocityCommandCfg.Ranges(lin_vel_x=(0.0, 1.0), lin_vel_y=(-0.5, 0.5), ang_vel_z=(-1.0, 1.0)),
    )
