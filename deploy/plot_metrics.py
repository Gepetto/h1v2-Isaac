...
def plot_joint_details(metrics: List[Dict], violations: List[Dict], save_dir: Path):
    ...
    for joint in joint_names:
        ...
        joint_violations = [v for v in violations 
                           if v['joint_name'] == joint]
...
def plot_base_metrics(metrics: List[Dict], violations: List[Dict], save_dir: Path):
    ...
    vel_violations = [v for v in violations 
                     if v['check_type'] == 'velocity' and v['joint_name'] == 'base']
...
def main():
    ...
    parser.add_argument('log_dir', type=str, 
                       help='Directory containing metrics.json and safety_check.json')
